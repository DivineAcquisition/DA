  ...
  return (
    <div className="relative w-full max-w-lg mx-auto my-12">
      <div className="space-y-3">
        {[
          { icon: '📞', label: 'Incoming Call', sublabel: 'AI picks up in < 60s', active: true },
          { icon: '🤖', label: 'AI Qualification', sublabel: 'Lead scored & routed', active: true },
          { icon: '📅', label: 'Auto-Booking', sublabel: 'Calendar synced', active: true },
          { icon: '🔄', label: 'Follow-Up Sequence', sublabel: '5-touch nurture', active: false },
          { icon: '📊', label: 'Data Logged', sublabel: 'Command center updated', active: false },
        ].map((step, i) => (
