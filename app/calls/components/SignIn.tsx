...
import { signInAction, signOutAction } from '@/lib/calls/actions';
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-ink-950 px-5 py-12 text-white antialiased">
      ...
      <div className="panel relative z-10 w-full max-w-md rounded-3xl p-8">
        ...
        {refusedFor ? (
          <>
            <h1 className="mt-6 text-xl font-semibold">This surface is admin-only</h1>
            <p className="mt-3 text-sm leading-relaxed text-neutral-400">
              {refusedFor} is signed in without an admin role. Call Intelligence is a single-operator
              tool.
            </p>
          ...
          <>
            <h1 className="mt-6 text-xl font-semibold">Call Intelligence</h1>
            <p className="mt-2 text-sm leading-relaxed text-neutral-400">
              Briefs, phone touches, and audit debriefs for Divine Acquisition&apos;s own pipeline.
              One account. Live from Airtable.
            </p>
            <form
