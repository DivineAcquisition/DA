...
import { airtableConfigured } from '@/lib/acq/pipeline';
import { calendarConfigured } from '@/lib/assessment/calendar';

export const dynamic = 'force-dynamic';

export default function ProspectCallsPage() {
  return (
    <div className="animate-rise">
      ...
      />
      <ProspectBookingPanel airtableReady={airtableConfigured()} calendarReady={calendarConfigured()} />
    </div>
  );
}
