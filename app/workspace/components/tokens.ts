...
export const ws = {
  ...
  input:
    'w-full rounded-xl border border-white/10 bg-white/[0.03] px-3.5 py-2.5 text-sm text-white placeholder:text-neutral-600 outline-none transition-colors focus:border-brand-500/60 focus:bg-white/[0.05]',
  select:
    'w-full cursor-pointer appearance-none rounded-xl border border-white/10 bg-ink-900 px-3.5 py-2.5 pr-9 text-sm text-white outline-none transition-colors focus:border-brand-500/60 focus:bg-white/[0.05]',
